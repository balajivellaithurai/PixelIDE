...
export default function CommandPalette() {
  ...
  const COMMANDS = [
    ...
    {
      id: "explain-function",
      title: "AI: Explain Current Function",
      category: "AI Superpowers",
      icon: FiHelpCircle,
      action: () => aiService.explainFunction(),
    },
    {
      id: "refactor-diff",
      title: "AI: Refactor Code (Diff Preview)",
      category: "AI Superpowers",
      icon: FiRefreshCcw,
      action: () => aiService.refactorCodeWithDiff(),
    },
    {
      id: "generate-comments",
      title: "AI: Generate Comments & Docstrings",
      category: "AI Superpowers",
      icon: FiFileText,
      action: () => aiService.generateComments(),
    },
    {
      id: "generate-readme",
      title: "AI: Generate README.md",
      category: "AI Superpowers",
      icon: FiBox,
